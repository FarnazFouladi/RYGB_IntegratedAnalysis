...
#####Plots
datasets<-c("BS","Assal","Afshar","Ilhan","BSMetagenomics")
folders<-c("RYGB_BS/Kraken2/","RYGB_Assal2020/Kraken2/","RYGB_Afshar2018/Kraken2/",
           "RYGB_Ilhan2020/Kraken2/","RYGB_BS_Metagenomics/")
myList<-list()
outdex<-1
for (study in datasets){
  ...
  if(study=="BS")
    ...
    labs(title = "BS")+scale_color_manual(labels=c("Baseline","1 month","6 months"),values = col)+coord_flip()
  else if(study=="Assal")
    ...
    coord_flip()+labs(title = "Assal")+scale_color_manual(values = col,labels=c("Baseline","3 months","1 year","2 years"))
  else if (study=="Afshar")
    plot1<-plot+coord_flip()+labs(title = "Afshar")+scale_color_manual(values = col,labels=c("Baseline","Post-surgery"))
  else if (study=="Ilhan")
    plot1<-plot+coord_flip()+labs(title = "Ilhan")+scale_color_manual(values = col,labels=c("Baseline","6 months","12 months"))
